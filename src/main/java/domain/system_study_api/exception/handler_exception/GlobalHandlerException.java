package domain.system_study_api.exception.handler_exception;

import domain.system_study_api.dto.ErrorGlobalResponse;
import domain.system_study_api.exception.BaseException;
